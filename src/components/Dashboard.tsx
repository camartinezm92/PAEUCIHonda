            ...
            >
              <div className="p-5 flex-grow">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center text-blue-700 font-bold text-xl group-hover:bg-blue-200 transition-colors">
